...
export function SidebarFooter({ collapsed }: { collapsed: boolean }) {
  ...
  if (collapsed) {
    return (
      <div className="mt-8 border-t border-slate-200 px-2 pt-4 dark:border-slate-700">
        <a
          href={linkWhatsapp}
          target="_blank"
  ...
  return (
    <div className="mt-8 border-t border-slate-200 px-3 pt-5 dark:border-slate-700">
